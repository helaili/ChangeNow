...
Checkout how couple tags in [the source code](https://github.com/helaili/ChangeNow/blob/master/src/components/Topbar.vue#L35) can help generating the documentation below. 
